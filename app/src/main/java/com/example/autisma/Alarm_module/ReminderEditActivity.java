...
public class ReminderEditActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.editor_activity_title_edit_reminder));
        ...
        if (mRepeat.equals("false")) {
            ...
            mRepeatText.setText(getString(R.string.repeat_off));
    ...
    public void updateReminder(){
        ...
        Toast.makeText(getApplicationContext(), getString(R.string.editDone),
