...
public class WavFile {
    ...
    public long numFrames;                    // Number of frames within the data section
    ...
    // Wav Header
    public int numChannels;                // 2 bytes unsigned, 0x0001 (1) to 0xFFFF (65,535)
    public long sampleRate;                // 4 bytes unsigned, 0x00000001 (1) to 0xFFFFFFFF (4,294,967,295)
